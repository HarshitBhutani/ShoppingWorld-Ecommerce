...
import { fetchAllProductsAsync, fetchBrandsAsync, fetchCategoriesAsync, fetchProductsByFiltersAsync, selectAllProducts, selectBrands, selectCategories, selectTotalItems } from '../../product-list/productSlice';
...
export default function AdminProductList() {
  ...
  const products = useSelector(selectAllProducts);   // or (state=> state.product.products)  // product is reducer and products is state
  ...
  useEffect(() => {  // jo condition lgai h pagination me to do some filtering vo aur ye linked h
    setPage(1);
  }, [totalItems, sort])   // bracket [] means jb totalItems ya sort change honge tbhi sirf useEffect chlega
  ...
  return (
    <div>
      <div className="bg-white">
        <div>
          <MobileFilter mobileFiltersOpen={mobileFiltersOpen} handleFilter={handleFilter} filters={filters} setMobileFiltersOpen={setMobileFiltersOpen}></MobileFilter>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {/* bottom me pages 1  2 3 4 5 6 . . . . starts here */}
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      ...
      <div className="flex flex-1 justify-between sm:hidden">
        ...
        <div
          onClick={(e) => handlePage(page < totalPages ? page + 1 : page)}  //agr last page na ho toh hi +1 kre nhi toh na kre
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            {/* below is the condition when we do some filtering of category, so the total results change.. to handle tht we wrote this */}
...
function ProductGrid({ products }) {
  return (
    ...
    <div className="bg-white">
      <div className="lg:col-span-3">
  <div>
    <Link to='/admin/product-form' className='rounded-md mx-10 my-5 bg-green-600 px-3 py-2 text-sm font-semibold leading-6 text-gray-900'>Add New Product</Link>
  </div>
</div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {products.map((product) => (
            <div>
              ...
              <div className='my-3'>
                <Link to={`/admin/product-form/edit/${product.id}`} className='rounded-md  bg-indigo-600 px-3 py-2 text-sm font-semibold leading-6 text-gray-800'>Edit Product</Link>
              </div>
            </div>
          ))}
        </div>
