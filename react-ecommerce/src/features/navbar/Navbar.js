...
function Navbar({ children }) {
    ...
    return (
        <>
            ...
            src="https://img.icons8.com/clouds/400/shopping-bag.png"
            alt="Shopping World"
                                                />
                                            </Link>
                                            ...
                                            <Menu as="div" className="relative ml-3">
                                                <div>
                                                    <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                                        ...
                                                        <img className="h-8 w-8 rounded-full" src="https://img.icons8.com/color/48/user-male-circle--v1.png" alt="" />
                                                    </Menu.Button>
                                                </div>
                                                <Transition
                                                    as={Fragment}
                                    ...
                                    <div className="flex items-center px-5">
                                        ...
                                        <Link to="/cart">
                                            ...
                                            >
                                                <span className="absolute -inset-1.5" />
                                                <span className="sr-only">View notifications</span>
                                                {items.length>0 &&<span className="inline-flex items-center rounded-md bg-red-50 -ml-3 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">
                                                    <ShoppingCartIcon className="h-6 w-6" aria-hidden="true" />
                                                    {items.length}
            ...
            alt="Shopping World"
          />
                        <h1 className="text-3xl font-bold tracking-tight text-gray-900">Shopping World</h1> 
                    </div>
                </header>
                <main>
